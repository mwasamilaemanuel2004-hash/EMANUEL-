...
class UltimateScalperBot:
    ...
    def _calculate_levels(self, action: TradeSide, current_price: float,
        ...
        min_profit = self.scalper_config.min_scalp_profit
        max_loss = self.scalper_config.max_scalp_loss
    ...
    def _calculate_position_size(self, action: TradeSide, current_price: float,
        ...
        position_value = self.capital * risk_per_scalp * mode_multiplier * streak_multiplier
