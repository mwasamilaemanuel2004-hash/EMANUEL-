...
class UniversalProfitEngine:
        ...
        for market in markets:
            ...
            for strategy in strategies:
                ...
                if result:
                    ...
                    if market not in self.best_strategies or result.win_rate > self.best_strategies[market].win_rate:
    ...
    def optimize_strategy(self, market: str, strategy: str, data: pd.DataFrame) -> Optional[StrategyResult]:
        ...
        for combo in product(*param_values):
            ...
            result = self._run_single_backtest(market, strategy, data, params)
            
            if result and result.total_trades >= 3:
                score = result.win_rate * 0.4 + result.profit_factor * 30 + result.sharpe_ratio * 10 - result.max_drawdown * 0.5
